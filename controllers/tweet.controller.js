const { createNewTweet, findAllTweets, findTweetAndDelete, findTweetById, findTweetAndUpdate, getCurrentUserTweetsFollowing } = require("../queries/tweet.queries");
...
exports.tweetlist = async (req, res, next) => {
    try {
        if(!req.user) {
            ...
            const tweets = await getCurrentUserTweetsFollowing(req.user)
